...
[看效果](#這個-skill-是怎麼長出來的) · [安裝與開發](#安裝與開發) · [知識圖譜](#知識圖譜) · [蒸餾了什麼](#蒸餾了什麼) · [Fork 維護說明](FORK.md)

</div>

本專案 fork 自 [`voidful/hung-yi-lee-skill`](https://github.com/voidful/hung-yi-lee-skill)，沿用 MIT License。主要定位為 **Windows-first 維護型 fork**，提供可重現的 Windows 11 開發環境驗收門禁、CI 工作流程與上游變更追蹤。上游原版英文說明請見 [`README.en.md`](README.en.md)，fork 維護取捨與差異清單見 [`FORK.md`](FORK.md)。
...
hung-yi-lee-skill/
├── SKILL.md                              # Skill 進入點
├── AGENTS.md                             # Wiki 維護 schema 與 Agent 指引
├── scripts/
