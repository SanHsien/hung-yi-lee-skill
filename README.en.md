...
# Hung-Yi Lee.skill (SanHsien Maintenance Fork)

<div align="center">

[![CI](https://github.com/SanHsien/hung-yi-lee-skill/actions/workflows/ci.yml/badge.svg)](https://github.com/SanHsien/hung-yi-lee-skill/actions/workflows/ci.yml)
...
[See It In Action](#see-it-in-action) · [How This Skill Grew Up](#how-this-skill-grew-up) · [Install](#install) · [Knowledge Graph](#knowledge-graph) · [What Was Distilled](#what-was-distilled) · [Fork Maintenance](FORK.md)

</div>

This repository is a Windows-first maintenance fork of [`voidful/hung-yi-lee-skill`](https://github.com/voidful/hung-yi-lee-skill), licensed under the MIT License. See [`README.md`](README.md) for the Traditional Chinese guide and [`FORK.md`](FORK.md) for maintenance differences.
...
### Windows 11 Native 1-Click Dev Gate (Recommended)

```powershell
git clone https://github.com/SanHsien/hung-yi-lee-skill.git
